...
model = pickle.load(open(r"C:\Users\KIIT0001\PycharmProjects\PythonProject\Heart-Disease-Pred\rf_classifier.pkl", 'rb'))
scaler = pickle.load(open(r"C:\Users\KIIT0001\PycharmProjects\PythonProject\Heart-Disease-Pred\scaler.pkl", 'rb'))
...
if __name__=='__main__':#Ensures this file runs only when executed directly
    app.run(debug=True)#Starts a local web server